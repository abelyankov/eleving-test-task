class QuarterFinalService < SolidService::Base
  ...
  def call
    ...
    return fail!(error: 'You can\'t generate quarter final games until all playoff games are played') unless division_games_played?
    return fail!(error: 'Playoff games not generated yet') unless playoff_games_played?
